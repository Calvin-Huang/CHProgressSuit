#
#  Be sure to run `pod spec lint CHProgressSuit.podspec' to ensure this is a
...
CHProgressSuit provides bundles of progess view for saving your time from wasting time to build these progress views. 
  ...
  # ――― Source Code ―――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――― #
  s.source_files  = "CHProgressSuit/CircularProgress.swift"
  ...
  s.dependency "CHCubicBezier", '~> 1.0'
